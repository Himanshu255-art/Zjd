...
function setup() {
 ...
 mickey=createSprite(200,499,39,40)
...
function draw() {
 ...
 if(gameState === "rules"){
   ...
   text("4: If the timer reaches 5000 before you score 50 points then you will loose the game",200,450)
   text("5: If you score 50 points before the timer reaches 5000 then you will win the game",200,500)
   text("6: Move the mouse up and down to move the police",200,550)
   text("7: If the zombies touches the police then you will loose the game",200,600)
   text("Winning the game is not important.Hardwork is the key to success",200,650)
  ...
  if(timer === 5000 && score<50 || vampireGroup.isTouching(Police) || zombieGroup.isTouching(Police) || zombiesGroup.isTouching(Police)){
   ...
   if(gameState === "win"){
    ...
    fill(290,100,28)
    text("PRESS LEFT ARROW KEY TO RESTART THE GAME",400,600)
    thumb.visible=true
